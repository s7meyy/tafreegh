...
2. حقل from يجب أن يطابق نصّ الفقرة **حرفًا بحرف**. لا تقتبس بتصرّف.
3. إن لم ترجّح بديلًا، لا تقترح شيئًا. ترك الخطأ أهون من اختراع كلام لم يُقَل.
4. لا تعِد كتابة النصّ. أخرج التعديلات وحدها.`;
